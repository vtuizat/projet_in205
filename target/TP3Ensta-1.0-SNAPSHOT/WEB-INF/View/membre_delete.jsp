  ...
  <main>
    <section class="content">
      ...
      <h5>Suppression du membre ${membre.id}</h5> <!-- TODO : remplacer 312 par l'id du membre -->
        <div class="row">
          <p>�tes-vous s�r de vouloir supprimer la fiche de ${membre.nom} ${membre.prenom} ?</p> <!-- TODO : remplacer prenomDuMembre et nomDuMembre par les valeurs correspondantes -->
